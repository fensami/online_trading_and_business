      ...
      <div className='md:w-full'>
        <div className='mt-16 card bg-[#171f2a] py-8 w-72 md:w-[70%] mx-auto'>
          ...
          <div className="join md:w-[60%]  mx-auto mb-4 md:mb-6">
            ...
            <select className="select select-bordered bg-[#131720]  md:h-24 join-item w-28 md:w-36">
            ...
            <div>
              <div >
                <input className="input bg-[#131720]  md:h-24 input-bordered text-end join-item md:w-full w-44" placeholder="$0.00" />
          ...
          <div className="join md:w-[60%] mx-auto">
            <select className="select select-bordered bg-[#131720] md:h-24 border-r-2 join-item w-28 md:w-36">
              <option disabled selected>Filter</option>
              <option>Bitcoin</option>
              <option>ETHEREUM</option>
              <option>TETHER USD</option>
