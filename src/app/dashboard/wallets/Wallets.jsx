...
const Wallets = () => {
  return (
    <div>
      <div className="md:flex md:ml-0 ml-4 md:px-12 pr-4 gap-4 mt-2">
        <div className="bg-[#212b39] mt-6 w-[50%]  md:w-[35%] rounded-lg p-8">
          ...
          <div className="text-center my-3">
            <button className="bg-green-600 text-sm px-3 btn-style hover:bg-black mx-3 py-1 rounded-lg">
              Withdraw
            </button>
            <button className="bg-black  text-sm px-3 btn-style hover:bg-green-500 py-1 rounded-lg">
              Deposite
            </button>
          </div>
        </div>
        <div className="bg-[#212b39] mt-6 w-[50%] md:w-[65%] p-6 rounded-lg card-body">
          <div>
          ...
          <div className="mt-5">
            ...
            <div className="flex my-3 w-full justify-between items-center">
              <p className="text-orange-400">45,8878930254</p>
              <p className="ml-12 text-xs">+955%</p>
            </div>
            <div>
