...
const UpCommingOther = async () => {
  ...
  return (
    <div className='mt-24 mb-24'>
      <div className='flex justify-center mb-24'><h1 className=' md:text-4xl font-bold'>Comming soon Offer</h1><span className="loading loading-dots loading-lg"></span></div>
      <div className="h-96 carousel carousel-vertical rounded-box grid justify-items-center gap-4">
      <div className="carousel-item h-full">
          <Image width={700} height={300} src={img4} alt='' />
        </div>
        
        <div className="carousel-item h-full">
          <Image width={700} height={300} src={img2} alt='' />
        </div>
        {/* <div className="carousel-item h-full">
        ...
        <div className="carousel-item h-full">
          <Image width={700} height={300} src={img6} alt=''/>
        </div>
        <div className="carousel-item h-full">
          <Image width={700} height={300} src={img7} alt='' />
        </div>
        <div className="carousel-item h-full">
          <Image width={700} height={300} src={img8} alt='' />
        </div>
        <div className="carousel-item h-full">
