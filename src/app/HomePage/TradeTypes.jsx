...
const TradeTypes = () => {
    return (
        <>
        <div className='bg-gray-600 text-center text-white py-3 '>
            ...
            <div className='md:flex justify-between items-center gap-5'>
                ...
                <div className='p-2 mt-10 md:mt-0'>
                    ...
                    <h3 className='text-2xl md:mt-10 mt-5 mb-5 font-semibold'>Options</h3>
                ...
                <div className=' p-2 mt-10 md:mt-0'>
                    ...
                    <h3 className='text-2xl md:mt-10 mt-5 mb-5 font-semibold'>Multipliers</h3>
