...
const TAbSection = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 mt-24">
      <h1 className="md:text-4xl text-2xl font-semibold md:font-bold mb-20 text-center">
      ...
      <div className="bg-[#171f2a] shadow-md rounded-md">
        ...
        <div className="flex space-x-4">
          <button
            className={`px-4 py-3 ${
              activeTab === 1 ? "bg-[#212b39] text-white" : "text-gray-600"
            }`}
          ...
          <button
            className={`px-4 py-3 ${
              activeTab === 2 ? "bg-[#212b39] text-white" : "text-gray-600"
            }`}
          ...
          <button
            className={`px-4 py-3 ${
              activeTab === 3 ? "bg-[#212b39] text-white" : "text-gray-600"
            }`}
              ...
              <table className="table">
                <tbody>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        TSLA<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        VERB<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Verb Technology Company, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>3.20</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        TLRY<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Tilray Brands, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>3.09</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        AMD<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Advanced Micro Devices Inc</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>110.78</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        BAC<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Bank of America Corporation</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>28.65</span>
              ...
              <table className="table">
                <tbody>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        GDC<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>GD Culture Group Limited</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>4.95</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        ARTL<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Artelo Biosciences, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>2.35</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        HHRS<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Hammerhead Energy Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>13.15</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        AVAV<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>AeroVironment, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>115.05</span>
              ...
              <table className="table">
                <tbody>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        HKIT<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Hitek Global Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>3.60</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        AMC<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>AMC Entertainment Holdings, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>8.62</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        HLGN<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Heliogen, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>6.22</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        OSTK<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Overstock.com, Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>20.99</span>
                  ...
                  <tr className="flex justify-between">
                    <td className="grid">
                      <span>
                        CLBR<sup className="text-orange-400">D_</sup>
                      </span>
                      <span>
                        <small>Clever Leaves Holdings Inc.</small>
                      </span>
                    </td>
                    <td className="grid justify-items-end">
                      <span>3.21</span>
