...
const Footer =async () => {
    ...
    return (
        <div className="md:mx-16 sm:mx-8 mx-4">
            ...
            <div className="md:flex  text-gray-500 justify-between items-center font-sans md:text-start text-center">
            ...
            <div className="grid lg:grid-cols-6  md:grid-cols-3 grid-cols-2 gap-4">
                <div className="py-8">
                    <h4 className="font-bold text-gray-500 text-1xl pb-4">ABOUT US</h4>
                ...
                <div className="py-8">
                    <h4 className="font-bold text-gray-500 text-1xl pb-4">MARKETS</h4>
                    <div className="flex flex-col text-slate-500 text-sm">
                        <a href="">Forex</a>
                ...
                <div className="py-8">
                    <h4 className="font-bold text-gray-500 text-1xl pb-4">LEGAL</h4>
                    <div className="flex flex-col text-slate-500 text-sm">
                ...
                <div className="py-8">
                    <h4 className="font-bold text-gray-500 text-1xl pb-4">PARTNER</h4>
                    <div className="flex flex-col text-slate-500 text-sm">
                ...
                <div className="py-8">
                    <h4 className="font-bold text-gray-500 text-1xl pb-4">SUPPORT</h4>
                    <div className="flex flex-col text-slate-500 text-sm">
            ...
            <div className="bg-gray-200 p-6 rounded-xl text-sm">
                <p className="text-slate-500">CFDs and other products offered on this website are complex instruments with high risk of losing money rapidly owing to leverage. You should consider whether you understand how these products work and whether you can afford to risk losing your money.s</p>
            </div>
        </div>
    );
};
