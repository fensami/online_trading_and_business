...
const TradeTypes = () => {
    return (
        <>
            <div className='text-center md:p-24 px-2 py-10 dark:bg-gray-200'>
                ...
                <div className='md:flex justify-between items-center gap-5'>
                    ...
                    <div className='p-2 mt-10 md:mt-0'>
                        <div className='flex dark:text-white light:text-black justify-center items-center'>
